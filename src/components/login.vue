<template>
  <div class="login-page">
    <div class="login-container">
      ...
      <button class="google-login-btn"> <img src="../assets/Google_logo.svg"  alt="Лого Google" width="20px" height="20px"> Log in with Google</button>
      ...
      <form @submit.prevent="submit" class="login-form">
        ...
        <div class="input-wrapper">
            <input type="password" id="password" name="password" class="form-input" v-model="password" required :type="passwordType">
        ...
        <div>
          <router-link to="/donelogin">
            <button type="submit" class="login-btn" :class="{ 'active': email && password && (!emailError)}">Войти</button>
          </router-link>
          <router-view></router-view>
        </div>
      </form>
