  ...
  <div class="login-page">
    ...
    <div class="login-container">
      ...
      <form @submit.prevent="submit" class="login-form">
        <label for="email" class="form-label" :class="{ invalid: emailError }">Введите почту или номер телефона</label>
        ...
        <div class="input-wrapper">
          <input id="password" name="password" class="form-input" v-model="password" required :class="{ invalid: passwordError }" :type="passwordType">
        ...
        <div class="input-wrapper">
          <input type="password" id="confirm" class="form-input" v-model="confirm" :class="{ invalid: confirmError }" :type="passwordType"/>
          <img class="toggle-password" src="../assets/eye.svg" @click="togglePassword">
        </div>
